...
import sanidan.createpdf.activity.FavouritesActivity;
import sanidan.createpdf.activity.MainActivity;
import sanidan.createpdf.customviews.MyCardView;
import sanidan.createpdf.fragment.texttopdf.TextToPdfFragment;
import sanidan.createpdf.model.HomePageItem;
import sanidan.createpdf.util.CommonCodeUtils;

import static sanidan.createpdf.util.Constants.ADD_IMAGES;
import static sanidan.createpdf.util.Constants.ADD_IMAGES_KEY;
import static sanidan.createpdf.util.Constants.ADD_PASSWORD_KEY;
import static sanidan.createpdf.util.Constants.ADD_PWD;
import static sanidan.createpdf.util.Constants.ADD_TEXT_KEY;
import static sanidan.createpdf.util.Constants.ADD_WATERMARK;
import static sanidan.createpdf.util.Constants.ADD_WATERMARK_KEY;
import static sanidan.createpdf.util.Constants.BUNDLE_DATA;
import static sanidan.createpdf.util.Constants.COMPRESS_PDF;
import static sanidan.createpdf.util.Constants.COMPRESS_PDF_KEY;
import static sanidan.createpdf.util.Constants.EXCEL_TO_PDF_KEY;
import static sanidan.createpdf.util.Constants.EXTRACT_IMAGES;
import static sanidan.createpdf.util.Constants.EXTRACT_IMAGES_KEY;
import static sanidan.createpdf.util.Constants.EXTRACT_TEXT_KEY;
import static sanidan.createpdf.util.Constants.HISTORY_KEY;
import static sanidan.createpdf.util.Constants.IMAGE_TO_PDF_KEY;
import static sanidan.createpdf.util.Constants.INVERT_PDF_KEY;
import static sanidan.createpdf.util.Constants.MERGE_PDF_KEY;
import static sanidan.createpdf.util.Constants.PDF_TO_IMAGES;
import static sanidan.createpdf.util.Constants.PDF_TO_IMAGES_KEY;
import static sanidan.createpdf.util.Constants.QR_BARCODE_KEY;
import static sanidan.createpdf.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static sanidan.createpdf.util.Constants.REMOVE_PAGES;
import static sanidan.createpdf.util.Constants.REMOVE_PAGES_KEY;
import static sanidan.createpdf.util.Constants.REMOVE_PASSWORD_KEY;
import static sanidan.createpdf.util.Constants.REMOVE_PWd;
import static sanidan.createpdf.util.Constants.REORDER_PAGES;
import static sanidan.createpdf.util.Constants.REORDER_PAGES_KEY;
import static sanidan.createpdf.util.Constants.ROTATE_PAGES;
import static sanidan.createpdf.util.Constants.ROTATE_PAGES_KEY;
import static sanidan.createpdf.util.Constants.SPLIT_PDF_KEY;
import static sanidan.createpdf.util.Constants.TEXT_TO_PDF_KEY;
import static sanidan.createpdf.util.Constants.VIEW_FILES_KEY;
import static sanidan.createpdf.util.Constants.ZIP_TO_PDF_KEY;
