...
import sanidan.createpdf.util.lambda.Consumer;

import static sanidan.createpdf.util.Constants.AUTHORITY_APP;
import static sanidan.createpdf.util.Constants.PATH_SEPERATOR;
