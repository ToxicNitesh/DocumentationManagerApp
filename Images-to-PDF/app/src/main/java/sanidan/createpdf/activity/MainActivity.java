...
import sanidan.createpdf.BuildConfig;
import sanidan.createpdf.R;
import sanidan.createpdf.fragment.ImageToPdfFragment;
import sanidan.createpdf.providers.fragmentmanagement.FragmentManagement;
...
import static sanidan.createpdf.util.Constants.IS_WELCOME_ACTIVITY_SHOWN;
import static sanidan.createpdf.util.Constants.LAUNCH_COUNT;
import static sanidan.createpdf.util.Constants.THEME_BLACK;
import static sanidan.createpdf.util.Constants.THEME_DARK;
import static sanidan.createpdf.util.Constants.THEME_SYSTEM;
import static sanidan.createpdf.util.Constants.THEME_WHITE;
import static sanidan.createpdf.util.Constants.VERSION_NAME;
