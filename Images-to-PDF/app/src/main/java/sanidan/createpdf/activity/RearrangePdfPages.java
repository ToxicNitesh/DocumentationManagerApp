...
import sanidan.createpdf.adapter.RearrangePdfAdapter;
import sanidan.createpdf.util.Constants;
import sanidan.createpdf.util.DialogUtils;
import sanidan.createpdf.util.ThemeUtils;

import static sanidan.createpdf.util.Constants.CHOICE_REMOVE_IMAGE;
import static sanidan.createpdf.util.Constants.RESULT;
import static sanidan.createpdf.util.Constants.SAME_FILE;
